...
def _read_movies_csv(
    movies_path: Path,
    tag_strings_by_movie: dict[int, tuple[str, ...]],
    max_movies: int | None,
) -> tuple[
    list[tuple[int, str, tuple[str, ...], int | None, tuple[str, ...]]],
    set[str],
    set[str],
]:
    ...
    return raw_movies, all_genres, all_tags
...
def _build_feature_tensors(
    ...
    return feature_id_list, offsets, values
...
def load_corpus(
    ...
    *,
    ...
    raw_movies, all_genres, all_tags = _read_movies_csv(
        movies_path, tag_strings_by_movie, max_movies
    )
    ...
    feature_id_list, offsets, values = _build_feature_tensors(
        documents, has_tags, replication_factor
    )
